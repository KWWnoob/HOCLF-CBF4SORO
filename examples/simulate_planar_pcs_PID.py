"""
Soft Robot PID + DCSAT Safety Barrier
==================================================================

This script simulates a planar soft robot (PCS: piecewise-constant strain)
tracking workspace waypoints with a **PID controller** augmented by 
**Safety Barrier Functions (CBFs)** based on the DCSAT 
(Differentiable Conservative Separating Axis Theorem) metric. 
