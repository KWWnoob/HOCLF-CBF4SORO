"""
Soft Robot HOCLF–HOCBF, with high withstanding force contact model
=================================================================

This script simulates a planar soft robot (PCS: piecewise-constant strain)
tracking waypoints using a **HOCLF–HOCBF  controller**. Safety is enforced with a
differentiable, conservative SAT (log-sum-exp) distance, and smooth
...
# Time settings.
    ...
    filename = f"HOCLF_allowable_force_{alpha}.csv"
