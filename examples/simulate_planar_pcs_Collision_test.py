    ...
    class SoRoConfig(CLFCBFConfig):
        ...
        def __init__(self):
            ...
            self.poly_obstacle_shape_2 = jnp.array([[0.0, 0.0],
                                                [0.0, char_length*0.8],
                                                [char_length*0.5, char_length*0.8],
                                                [char_length*0.5, 0.0]])
            ...
            self.p_des_1 = jnp.array([0.05951909, 0.15234353, -jnp.pi*1.8*robot_length])
            self.p_des_2 = jnp.array([0.1, 0.22234353, 0])
