    ...
    class SoRoConfig(CLFCBFConfig):
        ...
        def __init__(self):
            ...
            self.poly_obstacle_shape_1 = jnp.array([[0.0, 0.0],
                                                [0.0, char_length*2.5],
                                                [char_length*0.5, char_length*2.5],
                                                [char_length*0.5, 0.0]])
            ...
            self.p_des_1_2 = jnp.array([0.06, 0.16234353, 0])
            ...
            self.p_des_2_3 = jnp.array([0.23, 0.41234353, 0])

            self.p_des_3_1 = jnp.array([0.12, 0.28234353, 0])
            self.p_des_3_2 = jnp.array([0.20, 0.36, 0])
            self.p_des_3_3 = jnp.array([0.23, 0.50, 0])

            self.p_des_1 = jnp.stack([self.p_des_1_1,self.p_des_1_2, self.p_des_3_1])
            self.p_des_2 = jnp.stack([self.p_des_1_2,self.p_des_2_2, self.p_des_3_2])
            self.p_des_3 = jnp.stack([self.p_des_2_2,self.p_des_2_3, self.p_des_3_3])
